...
import json, sys, urllib.parse, cgi, urllib.request, urllib.parse, urllib.error, itertools, requests, time
...
def extract_url(entry):
    ...
    p = urllib.parse.urlparse(google_url)
    qargs = urllib.parse.parse_qs(p.query)
